...
// Surfaces facts the coach picked up from a check-in comment (an injury, an equipment
// change, a strong preference) so they can be confirmed into the athlete's profile
// instead of only affecting the single check-in they were mentioned in. Nothing here
// is written to athlete_memory until the athlete clicks Save — see
// athlete_memory_suggestions (migration 047) and services/ai/coaching_memory.py.
export function MemorySuggestionsCard({ suggestions }: Props) {
